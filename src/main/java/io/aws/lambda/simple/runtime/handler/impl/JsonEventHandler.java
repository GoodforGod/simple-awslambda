 ...
 */
@Singleton
public class JsonEventHandler extends AbstractEventHandler implements EventHandler {

    private final RequestHandler requestHandler;

    @Inject
    public JsonEventHandler(RequestHandler requestHandler, Converter converter) {
        super(converter);
